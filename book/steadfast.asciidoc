...
Now we're ready to stand up the first three layers in <<Dienst-Stack>>: Hardware, filesystem, and OS.
...
Read <<Digitale Sicherheit>> before forwarding any ports.
...
<<Digitale Sicherheit>> covers WAN access in detail.
