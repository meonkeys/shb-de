...
ACHTUNG: Wenn dir Fehlersuche und Debugging keinen Spaß machen, ist Self-Hosting vielleicht nichts für dich.
...
Füg das alles zusammen, und du erhältst mein absolut marketingfreundliches Akronym für ein Bedrohungsmodell: A.A/T/V.M. (jede Zeichensetzung wird mitgesprochen).
...
Die VPN-Technologie erhielt ein großes Upgrade durch [https://www.wireguard.com\[Wireguard](https://www.wireguard.com[Wireguard)].
...
Das Dateisystem des ((Containers) – also alles außer den gemounteten Volumes mit persistenten Daten – ist flüchtig (ephemeral) und liegt auf ext4 unter /var/lib/docker.
...
Die Installation des Betriebssystems ist im Allgemeinen schnell und schmerzlos, siehe Abschnitt 7.3 <<OS install>>.
