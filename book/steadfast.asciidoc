...
[#image-service-stack]
.Schichten eines Steadfast systems. Von unten, Hardware: bloßes Metal, Dateisystem: ext4 for / and optionally ZFS for /data, Betriebssystem: Ubuntu LTS 64-bit server, Containerlaufzeit: Docker, Container: Nextcloud Dateifreigabe, Jellyfin Medienserver, Wallabag Artikelleser.
...
Ein 1U-Server ist ein https://de.wikipedia.org/wiki/H%C3%B6heneinheit[Höheneinheit] hoch – etwa so groß wie eine lange Pizzaschachtel.
