...
. Richte einen eigenen Mail-Relay-Dienst ein, z. B. mit https://github.com/crazy-max/docker-msmtpd oder https://github.com/namshi/docker-smtp, 
damit alle mario-Dienste E-Mails darüber versenden können..
